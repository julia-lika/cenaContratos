class ContratoDois extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image('fornecedorDois', 'assets/fornecedores/fornecedorSprite_2.png');
    }
    ...
    create() {
      ...
      this.add.image(525, 330, 'fornecedorDois').setScale(2);
      ...
      var textoContratoDois = 'Contrato: \n ...';
      this.add.text(550, 200, textoContratoDois, {fontSize:'20px', fill:'0xFFFFFF'});
