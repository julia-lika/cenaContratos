class ContratoQuatro extends Phaser.Scene {
  ...
  create() {
    ...
    const fornecedor4 = this.add.image(570, 200, "fornecedor4").setScale(2);
    ...
    let arrayContrato4 = [retanguloContrato, retanguloFoto, text, fornecedor4, this.check, this.deny];
    this.add.container(larguraJogo / 6, alturaJogo / 10, arrayContrato4);
  }
